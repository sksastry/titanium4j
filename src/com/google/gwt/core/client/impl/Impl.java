/************************************************************************
 * Impl.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
...
public final class Impl {
    ...
    private static Timer watchdogEntryDepthTimer = null;
     ...
     * <code>Function.apply()</code> with the current <code>this</code> value
     * and the invocation arguments passed to <code>$entry</code>.
     * 
     * @param jsFunction
     *            a JS function to invoke, which is typically a JSNI reference
    ...
    public static native int getHashCode(Object o) /*-{
		return o.$H
				|| (o.$H = @com.google.gwt.core.client.impl.Impl::getNextHashId()());
    }-*/;
     ...
     * 
     * @param jsniIdent
     *            a string literal specifying a type, field, or method. Raw type
     *            names may also be used to obtain the name of the type's seed
     *            function.
     * @return the name by which the named member can be accessed at runtime, or
     *         <code>null</code> if the requested member has been pruned from
     *         the output.
    ...
    public static String getNameOf(String jsniIdent) {
         ...
         * method with a string literal expression.
         */
    ...
    private static native Object apply(Object jsFunction, Object thisObj, Object arguments) /*-{
		if (@com.google.gwt.core.client.GWT::isScript()()) {
    ...
    private static boolean enter() {
        ...
        if (GWT.isScript() && entryDepth != 0) {
            ...
            if (now - watchdogEntryDepthLastScheduled > WATCHDOG_ENTRY_DEPTH_CHECK_INTERVAL_MS) {
                ...
                watchdogEntryDepthTimer = watchdogEntryDepthSchedule();
            }
        }
     ...
     */
    private static Object entry0(Object jsFunction, Object thisObj, Object arguments) throws Throwable {
    ...
    private static void exit(boolean initialEntry) {
        ...
        if (initialEntry) {
            ...
            if (GWT.isScript() && watchdogEntryDepthTimer != null) {
                watchdogEntryDepthTimer.cancel();
                watchdogEntryDepthTimer = null;
            }
        }
    }
    ...
    private static void watchdogEntryDepthRun() {
        ...
        // This method is call from a "setTimeout": entryDepth should be set to
        // 0.
        if (GWT.isScript() && entryDepth != 0) {
            entryDepth = 0;
        }
        watchdogEntryDepthTimer = null; // Timer has run.
    }

    private static Timer watchdogEntryDepthSchedule() {
        Timer toRet = new Timer() {
