/************************************************************************
 * RemoteServiceProxy.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
...
public abstract class RemoteServiceProxy implements SerializationStreamFactory, ServiceDefTarget, HasRpcToken {
     ...
     * current service's {@link RpcToken} is of the type specified in
     * {@link RpcToken.RpcTokenImplementation} annotation.
     * 
     * @param token
     *            currently set {@link RpcToken}.
     */
    ...
    protected <T> RequestCallback doCreateRequestCallback(ResponseReader responseReader, String methodName,
        ...
        return new RequestCallbackAdapter<T>(this, methodName, statsContext, callback, getRpcTokenExceptionHandler(),
                        responseReader);
    }
        ...
        try {
            ...
            InvocationException iex = new InvocationException(
                            "Unable to initiate the asynchronous service invocation (" + methodName
                                            + ") -- check the network connection", ex);
