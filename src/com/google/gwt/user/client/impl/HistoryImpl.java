/************************************************************************
  HistoryImpl.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class HistoryImpl implements HasValueChangeHandlers<String> {
  ...
  public static HistoryImpl historyImpl = null;
  ...
  public static void onHashChanged() {
	  if (hash.length() > 0) {
		  token = historyImpl.decodeFragment(hash);
	  }
	  historyImpl.newItemOnEvent(token);
  }

  public native boolean init2() /*-{
//    var token = '';
//
