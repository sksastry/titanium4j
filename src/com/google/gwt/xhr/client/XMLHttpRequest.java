/************************************************************************
  XMLHttpRequest.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class XMLHttpRequest extends JavaScriptObject {
    ...
    private static XMLHttpRequest createForTi() {
        return Network.get().createHTTPClient().getJsObj().cast();
    }
    ...
    public static native XMLHttpRequest _create() /*-{
