/************************************************************************
  GMapAnnotation.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class GMapAnnotation extends EventDispatcher {
    ...
    public View getCustomView() {
        this.customView = View.from(new ProxyObject(_getCustomView()));
    ...
    static List<GMapAnnotation> fromArray(JavaScriptObject obj) {
        ...
        for (int i = 0; i < size; i++) {
            toReturn.add(new GMapAnnotation(JsoHelper.getValueFromJavaScriptObjectArray(obj, i)));
        }
        return toReturn;
    }
