/************************************************************************
  CloudPush.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
import com.emitrom.ti4j.mobile.client.core.handlers.cloudpush.CloudPushAppHandler;
    ...
    public native void addCallbackHandler(CloudPushCallbackHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.cloudpush.CloudPushCallbackEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.cloudpush.CloudPushCallbackHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/core/events/cloudpush/CloudPushCallbackEvent;)(eventObject);
						});
    }-*/;
    ...
    private native void addAppHandler(String event, CloudPushAppHandler handler)/*-{
		...
		jso
				.addEventListener(
						event,
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.cloudpush.CloudPushEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.cloudpush.CloudPushAppHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/core/events/cloudpush/CloudPushEvent;)(eventObject);
						});
    }-*/;
