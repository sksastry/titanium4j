...
public class PushNotificationConfig extends ProxyObject {
    ...
    public native void setCallback(PushNotificationCallback callback)/*-{
		...
		obj.error = function(e) {
			var error = @com.emitrom.ti4j.mobile.client.network.PushNotificationError::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
		...
		obj.success = function(s) {
			var success = @com.emitrom.ti4j.mobile.client.network.PushNotificationSuccess::new(Lcom/google/gwt/core/client/JavaScriptObject;)(s);
