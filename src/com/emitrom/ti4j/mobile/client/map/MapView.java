/************************************************************************
  MapView.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
 ...
 * {@link com.emitrom.ti4j.mobile.client.map.Map.createmapview} and is used
		...
		jso
				.addEventListener(
						...
						function(e) {
							...
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.loading.LoadCompleteHandler::onLoadComplete(Lcom/emitrom/ti4j/mobile/client/core/events/loading/LoadEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addErrorHandler(GeoErrorHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.geolocation.GeoErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.geolocation.GeoErrorHandler::onError(Lcom/emitrom/ti4j/mobile/client/core/events/geolocation/GeoErrorEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addRegionChangedHandler(RegionChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.RegionEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.geolocation.RegionChangeHandler::onRegionChange(Lcom/emitrom/ti4j/mobile/client/core/events/RegionEvent;)(eventObject);
						});
    }-*/;
