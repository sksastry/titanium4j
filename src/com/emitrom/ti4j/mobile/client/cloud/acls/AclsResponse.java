/************************************************************************
  AclsResponse.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
/**
 * Represents a response coming from a acls request
 */
public class AclsResponse extends AbstractHandlerResponse {

    public AclsResponse(JavaScriptObject obj) {
        jsObj = obj;
    }
