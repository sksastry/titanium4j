/************************************************************************
 * Geolocation.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
    ...
    public native void forwardGeocoder(String address, GeocoderCallback callback) /*-{
		...
		return jso
				.forwardGeocoder(
						address,
						function(e) {
							var place = @com.emitrom.ti4j.mobile.client.geolocation.Place::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.ti4j.mobile.client.geolocation.GeocoderCallback::onEvent(Lcom/emitrom/ti4j/mobile/client/geolocation/Place;)(place);
    ...
    public static native void reverseGeocoder(double latitude, double longitude, ReverseGeocoderCallback callback) /*-{
		...
		return jso
				.reverseGeocoder(
						...
						longitude,
						function(e) {
							var obj = @com.emitrom.ti4j.mobile.client.geolocation.ReverseGeocoderResult::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.ti4j.mobile.client.geolocation.ReverseGeocoderCallback::onEvent(Lcom/emitrom/ti4j/mobile/client/geolocation/ReverseGeocoderResult;)(obj);
						});
    }-*/;
