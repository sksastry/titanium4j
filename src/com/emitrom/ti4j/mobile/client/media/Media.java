/************************************************************************
  Media.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
import com.emitrom.ti4j.mobile.client.core.events.LineChangeEvent;
import com.emitrom.ti4j.mobile.client.core.events.RecordingInputEvent;
...
import com.emitrom.ti4j.mobile.client.core.handlers.media.VolumeHandler;
import com.emitrom.ti4j.mobile.client.media.android.AndroidMedia;
import com.emitrom.ti4j.mobile.client.media.ios.MusicPlayer;
...
public class Media extends TiModule {
     ...
     *         {@link com.emitrom.ti4j.mobile.client.media.ios.MusicPlayer}
    ...
    public native void takeScreenshot(ScrenShotCallback callback) /*-{
		...
		return jso
				.takeScreenshot(function(e) {
					...
					callback.@com.emitrom.ti4j.mobile.client.media.ScrenShotCallback::onEvent(Lcom/emitrom/ti4j/mobile/client/media/ScreenShotCallbackArguments;)(scObject);
				});
    }-*/;
    ...
    public native void addRecordinginputHandler(RecordingInputHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.RecordingInputEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.RecordingInputHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/core/events/RecordingInputEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addLineChangeHandler(LineChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.LineChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.LineChangeHandler::onLineChange(Lcom/emitrom/ti4j/mobile/client/core/events/LineChangeEvent;)(eventObject);
						});
    }-*/;
		...
		jso
				.addEventListener(
						...
						function(e) {
							...
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.VolumeHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/core/events/media/VolumentEvent;)(eventObject);
						});
    }-*/;
