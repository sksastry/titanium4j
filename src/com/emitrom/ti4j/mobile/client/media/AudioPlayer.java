/************************************************************************
  AudioPlayer.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
import com.emitrom.ti4j.mobile.client.core.handlers.media.ProgressHandler;
import com.emitrom.ti4j.mobile.client.core.handlers.media.audio.AudioChangeHandler;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * The audioplayer object is returned by
 * {@link com.emitrom.ti4j.mobile.client.media.Media.createAudioPlayer} and
...
public class AudioPlayer extends EventDispatcher {
    ...
    public native void addChangeHandler(AudioChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.ti4j.mobile.client.core.events.media.audio.ChangeEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.media.audio.ChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.audio.AudioChangeHandler::onChange(Lcom/emitrom/ti4j/mobile/client/core/events/media/audio/ChangeEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addProgressHandler(ProgressHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.ti4j.mobile.client.core.events.media.ProgressEvent::PROGRESS,
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.media.ProgressEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.ProgressHandler::onProgess(Lcom/emitrom/ti4j/mobile/client/core/events/media/ProgressEvent;)(eventObject);
						});
    }-*/;
