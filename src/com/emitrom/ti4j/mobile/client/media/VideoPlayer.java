/************************************************************************
  VideoPlayer.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
import com.emitrom.ti4j.mobile.client.core.handlers.media.video.VideoCompleteHandler;
 ...
 * {@link com.emitrom.ti4j.mobile.client.media.Media.createVideoPlayer} and
    ...
    public native void addCompleteHandler(VideoCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.media.video.VideoEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.video.VideoCompleteHandler::onComplete(Lcom/emitrom/ti4j/mobile/client/core/events/media/video/VideoEvent;)(eventObject);
						});
    }-*/;
