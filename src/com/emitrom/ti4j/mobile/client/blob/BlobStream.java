/************************************************************************
  BlobStream.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
/**
 * Wrapper around <code>Titanium.Blob</code> that implements the
 * <code>Titanium.IOStream</code> interface
 */
public class BlobStream extends Blob {

    public BlobStream() {
        jsObj = JsoHelper.createObject();
    }

    public BlobStream(JavaScriptObject obj) {
        jsObj = obj;
    }
