/************************************************************************
  Element.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
 ...
 * {@link com.emitrom.ti4j.mobile.client.xml.Node} defined by a start-tag and
 * end-tag (or an empty tag). elements may have
 * attributes(com.emitrom.ti4j.mobile.client.xml.Attr) associated with them.
...
public class Element extends Node {
     ...
     * @return The {@link com.emitrom.ti4j.mobile.client.xml.Attr} value as a
     ...
     * 
     * @param name The name of the attribute
     * @return The {@link com.emitrom.ti4j.mobile.client.xml.Attr} value, or
    ...
    /**
     * Retrieves a {@link com.emitrom.ti4j.mobile.client.xml.NodeList} of all
    ...
    /**
     * Retrieves an attribute value by local name and namespace uri, returning
     * it as a {@link com.emitrom.ti4j.mobile.client.xml.Attr} object.
     * 
     * @param namespaceURI The namespace URI of the attribute to retrieve.
     * @param localName The local name of the attribute to retrieve.
