/************************************************************************
  Android.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class Android extends TiModule {
    ...
    public native BroadcastReceiver createBroadcastReceiver() /*-{
		...
		var toReturn = @com.emitrom.ti4j.mobile.client.android.BroadcastReceiver::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void registerBroadcastReceiver(BroadcastReceiver broadcastReceiver, JsArrayString actions) /*-{
		...
		var obj = jso
				.registerBroadcastReceiver(
						broadcastReceiver.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()(),
						actions);
    }-*/;
    ...
    public native void unregisterBroadcastReceiver(BroadcastReceiver broadcastReceiver) /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var obj = jso
				.unregisterBroadcastReceiver(broadcastReceiver.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()());
    }-*/;
