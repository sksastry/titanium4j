/************************************************************************
  TiEventListener.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public abstract class TiEventListener<T extends TiEvent> {
    ...
    private static native JavaScriptObject createPeer(TiEventListener<?> listener) /*-{
		var callback = function(e) {
			...
			listener.@com.emitrom.ti4j.mobile.client.core.events.TiEventListener::fireOnEvent(Lcom/emitrom/ti4j/mobile/client/core/events/TiEvent;)(eventObject);
		};
