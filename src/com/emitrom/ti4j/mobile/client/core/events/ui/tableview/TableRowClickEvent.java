/************************************************************************
 * TableRowClickEvent.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
...
public class TableRowClickEvent extends InteractionEvent {
    ...
    protected TableRowClickEvent() {

    }

    private TableRowClickEvent(JavaScriptObject jso) {
        this.jsObj = jso;
    }
