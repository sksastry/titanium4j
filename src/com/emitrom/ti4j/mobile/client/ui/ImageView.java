    ...
    public native void addChangeHandler(ImageActionHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.ui.image.ImageEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.ui.ImageActionHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/core/events/ui/image/ImageEvent;)(eventObject);
						});
    }-*/;
