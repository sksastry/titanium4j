 ...
 * com.emitrom.ti4j.mobile.client.ui.UI.createPicker. A picker can be used to
...
public class Picker extends View {
     ...
     *         {@link com.emitrom.ti4j.mobile.client.ui.UI.PICKER_TYPE_TIME}
    ...
    public native void addChangeHandler(PickerChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.ui.picker.PickerChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.ui.PickerChangeHandler::onChange(Lcom/emitrom/ti4j/mobile/client/core/events/ui/picker/PickerChangeEvent;)(eventObject);
						});
    }-*/;
    ...
    public static Picker from(ProxyObject proxy) {
