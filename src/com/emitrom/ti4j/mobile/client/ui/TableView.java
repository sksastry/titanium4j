/************************************************************************
 * TableView.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
...
public class TableView extends View {
    ...
    public native CallbackRegistration addTableRowDeleteHandler(TableRowDeleteHandler handler)
    /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var listener = function(e) {
			var eventObject = @com.emitrom.ti4j.mobile.client.core.events.ui.tableview.TableRowDeleteEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			handler.@com.emitrom.ti4j.mobile.client.core.handlers.ui.TableRowDeleteHandler::onTableRowDelete(Lcom/emitrom/ti4j/mobile/client/core/events/ui/tableview/TableRowDeleteEvent;)(eventObject);
		};
		var name = @com.emitrom.ti4j.mobile.client.core.events.ui.tableview.TableRowDeleteEvent::EVENT_NAME;
		var v = jso.addEventListener(name, listener);
		var toReturn = @com.emitrom.ti4j.mobile.client.core.handlers.ui.CallbackRegistration::new(Lcom/emitrom/ti4j/mobile/client/ui/UIObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,name,listener);
		return toReturn;
    ...
    public native CallbackRegistration addTableRowDoubleTapHandler(TableRowDoubleTapHandler handler)
    /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var listener = function(e) {
			var eventObject = @com.emitrom.ti4j.mobile.client.core.events.ui.tableview.TableRowDoubleTapEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			handler.@com.emitrom.ti4j.mobile.client.core.handlers.ui.TableRowDoubleTapHandler::onTableRowDoubleTap(Lcom/emitrom/ti4j/mobile/client/core/events/ui/tableview/TableRowDoubleTapEvent;)(eventObject);
		};
		var name = @com.emitrom.ti4j.mobile.client.core.events.ui.tableview.TableRowDoubleTapEvent::EVENT_NAME;
		var v = jso.addEventListener(name, listener);
		var toReturn = @com.emitrom.ti4j.mobile.client.core.handlers.ui.CallbackRegistration::new(Lcom/emitrom/ti4j/mobile/client/ui/UIObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,name,listener);
		return toReturn;
