/************************************************************************
 * IPad.java is part of Ti4j 3.1.0 Copyright 2013 Emitrom LLC
 * 
...
public class IPad extends TiModule {
    ...
    static native JavaScriptObject createSplitWindow(View detail, View master) /*-{
		var d = detail.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var m = master.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
