/************************************************************************
  Matrix3D.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class Matrix3D extends EventDispatcher {
    ...
    public native Matrix3D invert() /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var obj = jso.invert();
		var toReturn = @com.emitrom.ti4j.mobile.client.ui.ios.Matrix3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public static Matrix3D from(ProxyObject obj) {
