/************************************************************************
  Contacts.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class Contacts extends TiModule {
    ...
    /**
     * Returns an of all {@link com.emitrom.ti4j.mobile.client.contacts.Group}
     * objects in the contacts database.Only available on iOs.
     */
    public native List<Group> getAllGroups() /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var oj = jso.getAllGroups();
		return @com.emitrom.ti4j.mobile.client.contacts.Group::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    /**
     * Returns an array of
     * {@link com.emitrom.ti4j.mobile.client.contacts.Person} objects who have a
    ...
    /**
     * Returns a {@com.emitrom.ti4j.mobile.client.contacts.Person} object with
     * the given id
     * 
     * @param id
     ...
     * @param group
     *            The {@link com.emitrom.ti4j.mobile.client.contacts.Group}
     ...
     * 
     * @param person
     *            The {@link com.emitrom.ti4j.mobile.client.contacts.Person}
     *            object to remove from the database.
     */
    ...
    public native void requestAuthorization(ContactAuthorizationHandler callback) /*-{
		...
		jso
				.requestAuthorization(function(r) {
					var resp = @com.emitrom.ti4j.mobile.client.contacts.ContactsAuthorizationResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
					callback.@com.emitrom.ti4j.mobile.client.contacts.ContactAuthorizationHandler::onEvent(Lcom/emitrom/ti4j/mobile/client/contacts/ContactsAuthorizationResponse;)(resp);
				});
    }-*/;
    ...
    public static native void save(List<Person> values) /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		var toSave = @com.emitrom.ti4j.mobile.client.contacts.Person::fromList(Ljava/util/List;)(values);
		jso.save(toSave);
    }-*/;
