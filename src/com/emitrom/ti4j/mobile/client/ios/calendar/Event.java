/************************************************************************
  Event.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class Event extends EventDispatcher {
    ...
    public final native RecurrenceRule getReccurenceRule() /*-{
		...
		return @com.emitrom.ti4j.mobile.client.ios.calendar.RecurrenceRule::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public final native void removeRecurrenceRule(RecurrenceRule value) /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		jso
				.removeRecurrenceRule(value.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native void setRecurrenceRule(RecurrenceRule value) /*-{
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
		jso
				.setRecurrenceRule(value.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()());
    }-*/;
    ...
    public final native void setRecurrenceRules(List<RecurrenceRule> values) /*-{
		var peers = @com.emitrom.ti4j.mobile.client.ios.calendar.RecurrenceRule::fromList(Ljava/util/List;)(values);
		var jso = this.@com.emitrom.ti4j.core.client.ProxyObject::getJsObj()();
